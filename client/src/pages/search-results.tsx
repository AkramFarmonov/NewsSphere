        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          {initialQuery && (
            <p className="mt-4 text-gray-600" data-testid="search-query-display">
              "<span className="font-medium">{initialQuery}</span>" uchun qidiruv natijalari
            </p>
          )}
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow-sm" data-testid="no-results">
            ...
            <p className="text-gray-600 mb-6">
              "<span className="font-medium">{initialQuery}</span>" bo'yicha hech qanday natija topilmadi.
            </p>
